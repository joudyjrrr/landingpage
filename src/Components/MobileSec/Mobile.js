...
const Mobile = ()=>{
    return(
        <div className="index"  data-aos="fade-up"   data-aos-duration="1000"  data-aos-delay="1000">
        ...
        <div className="index2-content"  data-aos="fade-up"   data-aos-duration="1000"  data-aos-delay="1000"> 
           <div className="text-content">
